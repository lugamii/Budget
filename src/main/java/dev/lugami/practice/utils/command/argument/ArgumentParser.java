...
import dev.lugami.practice.utils.command.annotation.Flag;
import dev.lugami.practice.utils.command.command.CommandExecution;
import dev.lugami.practice.utils.command.command.CommandFlag;
import dev.lugami.practice.utils.command.command.DrinkCommand;
import dev.lugami.practice.utils.command.command.DrinkCommandService;
import dev.lugami.practice.utils.command.exception.CommandArgumentException;
